...
data type PatientInfo from MedicalDemoInfo.idl.
This example builds two applications, named MedicalDemoInfo_publisher and
MedicalDemoInfo_subscriber.

To Build this Example:
======================
1. Launch Visual Studio in one of two ways:
        - By typing MedicalDemoInfo-x64Win64VS2017.sln in the
          Command Prompt window.
        - By opening Visual Studio on your machine and then opening the
          MedicalDemoInfo-x64Win64VS2017.sln file (in the
...
2. Select Build Solution from the Build menu. (You can also right-click
   MedicalDemoInfo_publisher or MedicalDemoInfo_subscriber and
...
To modify the data being sent: edit the MedicalDemoInfo_publisher.cxx
file where it says 
...
1. Right-click MedicalDemoInfo_publisher and choose Debug > Start new instance.
2. Right-click MedicalDemoInfo_subscriber and choose Debug > Start new instance.
...
> objs\x64Win64VS2017\MedicalDemoInfo_publisher.exe <domain_id> <sample_count>
> objs\x64Win64VS2017\MedicalDemoInfo_subscriber.exe <domain_id> <sample_count>